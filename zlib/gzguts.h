...
/* unistd.h provides lseek/read/write/close on POSIX. zlib historically
 * relied on these being pulled in transitively, but modern SDKs (e.g.
 * macOS SDK 26+) no longer do so. Include it explicitly when available. */
